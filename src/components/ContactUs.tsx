...
const ContactUs = () => {
  ...
  const faqs = [
    {
      question: 'چگونه از پیک خورشید اهواز وام بگیرم؟',
      answer: 'پاسخ به سوالات شما درباره نحوه دریافت وام سفر پیک خورشید'
    },
    {
      question: 'برای دریافت وام پیک خورشید اهواز چه مدارکی باید داشته باشم؟',
      answer: 'برای دریافت وام نیاز به مدارک شناسایی معتبر، مدارک شغلی و درآمدی (بسته به نوع شغل) و مدارک تضمینی خواهید داشت. برای اطلاعات دقیق‌تر با کارشناسان ما تماس بگیرید.'
    },
    {
      question: '«وام کارت» چیست و چطور باید از آن استفاده کنم؟',
      answer: 'وام کارت، کارت اعتباری پیک خورشید است که امکان تقسیط هزینه سفر شما را فراهم می‌کند. پس از دریافت می‌توانید آن را همانند کارت بانکی خود استفاده کنید.'
    },
    {
      question: 'تفاوت وام کارت آبی و سفید در چیست؟',
      answer: 'وام کارت آبی و سفید در سقف اعتباری، مدت بازپرداخت و شرایط دریافت متفاوت هستند. کارت آبی دارای اعتبار بیشتر و دوره بازپرداخت طولانی‌تر است.'
    },
    {
      question: 'آیا برای دریافت وام از پیک خورشید اهواز نیاز به ضامن دارم؟',
      answer: 'برای برخی از انواع وام‌ها و بسته به مبلغ درخواستی ممکن است نیاز به ضامن داشته باشید. برای وام‌های با مبلغ کمتر، معمولاً سفته الکترونیکی کفایت می‌کند.'
    }
  ];
